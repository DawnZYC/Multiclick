...
from multiclick.models import ClickProgress, ClickResult, KeyboardClickConfig
from multiclick.services.keyboard_support import resolve_keyboard_target


class KeyboardClickRunner:
    def __init__(
        self,
    ...
    def _run(self) -> None:
        ...
        target_key = resolve_keyboard_target(self._config.target)
